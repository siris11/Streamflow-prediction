...
def get_args() -> Dict:
    ...
    parser.add_argument(
        '--num_workers', type=int, default=4, help="Number of parallel threads for data loading")
    parser.add_argument(
        '--no_static',
        type=str2bool,
        default=False,
...
def train(cfg):
    ...
    cfg = _prepare_data(cfg=cfg, basins=['01013500'])
...
def train_epoch(model: nn.Module, optimizer: torch.optim.Optimizer, loss_func: nn.Module,
    ...
    for data in pbar:
        ...
        x, y, q_stds = data[0],data[2],data[3]
